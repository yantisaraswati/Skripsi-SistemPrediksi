 ...
 * MyBatis Generator
 */
public class NamingRuleNormalizer extends PluginAdapter {

    /**
     * Constructor
     */
    public NamingRuleNormalizer() {
    }
     ...
     * @param oldString To replace (remove) name
     * @param newString To replace (overwrite) name
     * @param sourceString To replace whole string
     * @return Replaced string
     */
     ...
     * @param introspectedTable Information of table introspected by MyBatis Generator
     */
    @Override
