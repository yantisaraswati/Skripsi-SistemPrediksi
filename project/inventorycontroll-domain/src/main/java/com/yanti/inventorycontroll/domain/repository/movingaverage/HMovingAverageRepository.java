...
public interface HMovingAverageRepository {
    ...
    int updateByCriteriaSelective(@Param("row") HMovingAverage row, @Param("criteria") HMovingAverageCriteria criteria);

    int updateByCriteria(@Param("row") HMovingAverage row, @Param("criteria") HMovingAverageCriteria criteria);
