...
--
-- Name: t_apriori_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.t_apriori_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.h_apriori (
    apriori_id bigint DEFAULT nextval('public.t_apriori_seq'::regclass) NOT NULL,
    organization_id bigint NOT NULL,
    label character varying NOT NULL,
    support integer NOT NULL,
    support_aub integer NOT NULL,
...
--
-- Name: h_apriori_item; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.h_apriori_item (
    apriori_item_id bigint DEFAULT nextval('public.t_apriori_item_seq'::regclass) NOT NULL,
...
CREATE TABLE public.h_moving_average (
    moving_average_id bigint DEFAULT nextval('public.t_moving_average_seq'::regclass) NOT NULL,
    organization_id bigint NOT NULL,
    item_id bigint NOT NULL,
...
COPY public.h_apriori (apriori_id, organization_id, label, support, support_aub, confidence, rules, created_by, created_date, updated_by, updated_date) FROM stdin;
\.


--
-- Data for Name: h_apriori_item; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.h_apriori_item (apriori_item_id, apriori_id, item_id, created_by, created_date, updated_by, updated_date) FROM stdin;
\.
...
COPY public.h_moving_average (moving_average_id, organization_id, item_id, quantity, year, month, created_by, created_date, updated_by, updated_date) FROM stdin;
\.
...
1	1	Adhi WIrawan	adhi		1	2022-12-14 10:28:06.49819	1	2022-12-14 10:28:06.49819
2	4	Asri	asri		1	2022-12-14 10:28:06.506649	1	2022-12-14 10:28:06.506649
3	4	Avin	avin		1	2022-12-14 10:28:06.509868	1	2022-12-14 10:28:06.509868
4	2	Bidang 3	bidang3		1	2022-12-14 10:28:06.511845	1	2022-12-14 10:28:06.511845
5	4	Defri	defri		1	2022-12-14 10:28:06.515115	1	2022-12-14 10:28:06.515115
6	1	Eka Pan Lestari	eka		1	2022-12-14 10:28:06.520722	1	2022-12-14 10:28:06.520722
7	2	Hillary	hillary		1	2022-12-14 10:28:06.525037	1	2022-12-14 10:28:06.525037
8	1	Idzar	idzar		1	2022-12-14 10:28:06.527373	1	2022-12-14 10:28:06.527373
9	3	Jajang_Bidang Diklat I	jajang		1	2022-12-14 10:28:06.530917	1	2022-12-14 10:28:06.530917
10	3	Joko	joko		1	2022-12-14 10:28:06.537396	1	2022-12-14 10:28:06.537396
11	1	Kusni	kusni		1	2022-12-14 10:28:06.542	1	2022-12-14 10:28:06.542
12	4	Lica	lica		1	2022-12-14 10:28:06.545982	1	2022-12-14 10:28:06.545982
13	4	Pak Budi	budi		1	2022-12-14 10:28:06.549875	1	2022-12-14 10:28:06.549875
14	4	Stop Opname	stopopname		1	2022-12-14 10:28:06.553003	1	2022-12-14 10:28:06.553003
15	2	Wahyu Hermansah	wahyu		1	2022-12-14 10:28:06.558879	1	2022-12-14 10:28:06.558879
16	4	Yanti	yanti		1	2022-12-14 10:28:06.560826	1	2022-12-14 10:28:06.560826
\.
...
--
-- Name: t_apriori_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.t_apriori_seq', 1, false);
...
--
-- Name: t_apriori_item_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_apriori_item
    ADD CONSTRAINT t_apriori_item_pkey PRIMARY KEY (apriori_item_id);


--
-- Name: t_apriori_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_apriori
    ADD CONSTRAINT t_apriori_pkey PRIMARY KEY (apriori_id);


--
-- Name: t_moving_average_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_moving_average
    ADD CONSTRAINT t_moving_average_pkey PRIMARY KEY (moving_average_id);
...
--
-- Name: FK_t_apriori_item_m_item; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_apriori_item
    ADD CONSTRAINT "FK_t_apriori_item_m_item" FOREIGN KEY (item_id) REFERENCES public.m_item(item_id);


--
-- Name: FK_t_apriori_item_t_apriori; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_apriori_item
    ADD CONSTRAINT "FK_t_apriori_item_t_apriori" FOREIGN KEY (apriori_id) REFERENCES public.h_apriori(apriori_id);


--
-- Name: FK_t_apriori_m_organization; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_apriori
    ADD CONSTRAINT "FK_t_apriori_m_organization" FOREIGN KEY (organization_id) REFERENCES public.m_organization(organization_id);


--
-- Name: FK_t_moving_average_m_item; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_moving_average
    ADD CONSTRAINT "FK_t_moving_average_m_item" FOREIGN KEY (item_id) REFERENCES public.m_item(item_id);


--
-- Name: FK_t_moving_average_m_organization; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.h_moving_average
    ADD CONSTRAINT "FK_t_moving_average_m_organization" FOREIGN KEY (organization_id) REFERENCES public.m_organization(organization_id);
